...
Further improvements included:<br>
• refined embedding representations using metadata<br>
• URL canonicalization<br>
• catalog filtering<br>
• refined mixed-query balancing<br> 

Evaluation was performed using:

python evaluate.py <br><br>
